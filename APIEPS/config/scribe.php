...
return [
    ...
    'title' => config('app.name') . ' - Documentación de la API',
    ...
    'auth' => [
        ...
        'extra_info' => 'Puedes obtener tu token accediendo a tu panel de control y haciendo clic en <b>Generar token de API</b>.',
    ],
